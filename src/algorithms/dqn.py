...
from networks.q_network import DuelingQNetwork, QNetwork
...
class DQNAgent:
    ...
    def __init__(
        ...
        self.memory = ReplayBuffer(
            capacity=self.config["buffer_size"], batch_size=self.config["batch_size"]
        )
    ...
    def _init_networks(self):
        ...
        network_class = (
            DuelingQNetwork if self.config.get("dueling_dqn", False) else QNetwork
        )
